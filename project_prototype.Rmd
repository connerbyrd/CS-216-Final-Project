...
```{r upsampling, include = TRUE, fig.width = 5, fig.height = 3, fig.cap = "Upsampled Counts of Individuals with and without Heart Disease"}
...
```{r, include = TRUE, echo = FALSE, fig.height = 4, fig.width = 6, fig.cap = "Error Lines for Random Forest"}
set.seed(1)
